...
void main() {
  test('validate mewajibkan pilihan master atau manual Yang lain', () {
  ...
  test('buildFormData memetakan field multipart tanpa foto', () async {
    const draft = B3StorageDraft(
      ...
      movementType: 'MASUK',
      wasteTypeId: 1,
      initiatorDepartmentOther: 'Laboratorium',
      weightKg: '50',
      documentNumber: 'DOC-1',
      note: 'Masuk gudang',
    );
    ...
    expect(fields['initiator_department_id'], '');
    expect(fields['initiator_department_other'], 'Laboratorium');
